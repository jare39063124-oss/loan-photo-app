...
def add_title_bar(slide, title_text):
    ...
    line = slide.shapes.add_shape(MSO_SHAPE.RECTANGLE, Inches(0.5), Inches(1.05), Inches(2), Inches(0.06))
    line.fill.solid()
...
def create_presentation():
    ...
    add_textbox(slide, Inches(0.5), Inches(1.4), Inches(6.5), Inches(0.5),
                "功能介绍", font_size=22, bold=True, color=ACCENT_BLUE)
    
    txBox = slide.shapes.add_textbox(Inches(0.5), Inches(1.95), Inches(6.5), Inches(2.8))
    tf = txBox.text_frame
    tf.word_wrap = True
    p = tf.paragraphs[0]
    ...
    for feat in features:
        add_paragraph(tf, "  - " + feat, font_size=15, color=LIGHT_GRAY, space_before=Pt(6))
    
    add_textbox(slide, Inches(0.5), Inches(4.9), Inches(6.5), Inches(0.5),
                "适用场景", font_size=22, bold=True, color=ACCENT_BLUE)
    
    txBox2 = slide.shapes.add_textbox(Inches(0.5), Inches(5.45), Inches(6.5), Inches(1.5))
    ...
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(0.6), screen_w - Inches(0.6), Inches(0.6),
                       "资产盘点拍照工具", bg_color=ACCENT_BLUE, font_size=13)
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(1.5), screen_w - Inches(0.6), Inches(0.55),
                       "[导入Excel]  按钮", font_size=10)
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(2.25), screen_w - Inches(0.6), Inches(0.55),
                       "[设置]     按钮", font_size=10)
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(3.1), screen_w - Inches(0.6), Inches(2.0),
                       "客户列表区域\n显示所有导入的客户\n点击进入拍照", font_size=9)
    ...
    add_textbox(slide, Inches(0.5), Inches(1.4), Inches(6.5), Inches(0.5),
                "欢迎页介绍", font_size=22, bold=True, color=ACCENT_BLUE)
    
    txBox = slide.shapes.add_textbox(Inches(0.5), Inches(1.95), Inches(6.5), Inches(1.8))
    tf = txBox.text_frame
    tf.word_wrap = True
    p = tf.paragraphs[0]
    ...
    add_textbox(slide, Inches(0.5), Inches(3.9), Inches(6.5), Inches(0.5),
                "权限说明", font_size=22, bold=True, color=ACCENT_BLUE)
    
    txBox2 = slide.shapes.add_textbox(Inches(0.5), Inches(4.45), Inches(6.5), Inches(2.5))
    tf2 = txBox2.text_frame
    tf2.word_wrap = True
    p2 = tf2.paragraphs[0]
    ...
    for perm in perms:
        add_paragraph(tf2, "  - " + perm, font_size=15, color=LIGHT_GRAY, space_before=Pt(6))
    ...
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(0.6), screen_w - Inches(0.6), Inches(0.9),
                       "欢迎使用\n资产盘点拍照工具", bg_color=DARK_GRAY, font_size=11)
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(1.8), screen_w - Inches(0.6), Inches(1.5),
                       "引导图区域\n展示功能介绍", font_size=9)
    add_screen_element(slide, screen_left + Inches(0.8), screen_top + Inches(3.6), screen_w - Inches(1.6), Inches(0.55),
                       "[ 开始使用 ]", bg_color=ACCENT_BLUE, font_size=11)
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(4.5), screen_w - Inches(0.6), Inches(0.45),
                       "允许相机权限？", font_size=9)
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(5.1), (screen_w - Inches(0.6)) / 2 - Inches(0.1), Inches(0.4),
                       "拒绝", font_size=9)
    add_screen_element(slide, screen_left + Inches(0.3) + (screen_w - Inches(0.6)) / 2 + Inches(0.1), screen_top + Inches(5.1), (screen_w - Inches(0.6)) / 2 - Inches(0.1), Inches(0.4),
                       "允许", bg_color=ACCENT_BLUE, font_size=9)
    ...
    add_textbox(slide, Inches(0.5), Inches(1.4), Inches(6.5), Inches(0.5),
                "Excel格式要求", font_size=22, bold=True, color=ACCENT_BLUE)
    
    txBox = slide.shapes.add_textbox(Inches(0.5), Inches(1.95), Inches(6.5), Inches(1.5))
    tf = txBox.text_frame
    tf.word_wrap = True
    p = tf.paragraphs[0]
    ...
    add_screen_element(slide, screen_left + Inches(0.2), screen_top + Inches(0.5), screen_w - Inches(0.4), Inches(0.4),
                       " <- 返回   导入Excel", bg_color=ACCENT_BLUE, font_size=10)
    ...
    for r_idx, row in enumerate(rows):
        for c_idx, val in enumerate(row):
            add_screen_element(slide, excel_x + col_w * c_idx, excel_y + Inches(0.32) * (r_idx + 1),
                               col_w, Inches(0.32), val, font_size=7)
    
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(2.8), screen_w - Inches(0.6), Inches(0.5),
                       "[ 选择文件 ]", bg_color=ACCENT_BLUE, font_size=11)
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(3.5), screen_w - Inches(0.6), Inches(0.6),
                       "导入成功！\n共导入 3 条客户数据", bg_color=RGBColor(0x2D,0x5A,0x2D), font_size=9)
    ...
    add_textbox(slide, Inches(0.5), Inches(1.4), Inches(6.5), Inches(0.5),
                "列表布局说明", font_size=22, bold=True, color=ACCENT_BLUE)
    
    txBox = slide.shapes.add_textbox(Inches(0.5), Inches(1.95), Inches(6.5), Inches(5.0))
    tf = txBox.text_frame
    tf.word_wrap = True
    ...
    for title, desc in items[1:]:
        p = add_paragraph(tf, title + desc, font_size=15, color=LIGHT_GRAY, space_before=Pt(8))
        p.runs[0].font.bold = True
    
    screen_left = Inches(7.5)
    screen_top = Inches(1.3)
    screen_w = Inches(4.8)
    screen_h = Inches(5.6)
    phone = add_phone_screen(slide, screen_left, screen_top, screen_w, screen_h, "客户列表页")
    
    add_screen_element(slide, screen_left + Inches(0.2), screen_top + Inches(0.5), screen_w - Inches(0.4), Inches(0.4),
                       "客户列表  总:3  已完成:1", bg_color=ACCENT_BLUE, font_size=9)
    
    add_screen_element(slide, screen_left + Inches(0.2), screen_top + Inches(1.05), screen_w - Inches(0.4), Inches(0.28),
                       "客户名          地址                     进度", bg_color=RGBColor(0x44,0x44,0x55), font_size=7)
    
    list_y = screen_top + Inches(1.45)
    for i in range(3):
        bg = RGBColor(0x30,0x30,0x3D) if i % 2 == 0 else SCREEN_BG
        add_screen_element(slide, screen_left + Inches(0.2), list_y + Inches(1.0)*i, screen_w - Inches(0.4), Inches(0.9),
        ...
        add_screen_element(slide, screen_left + Inches(0.3), list_y + Inches(1.0)*i + Inches(0.5), Inches(1.5), Inches(0.3),
                           "[拍照]", bg_color=ACCENT_BLUE, font_size=8)
        add_screen_element(slide, screen_left + Inches(1.9), list_y + Inches(1.0)*i + Inches(0.5), Inches(2.0), Inches(0.3),
                           "[查看已拍]", bg_color=RGBColor(0x55,0x55,0x66), font_size=8)
    ...
    add_textbox(slide, Inches(0.5), Inches(1.4), Inches(6.5), Inches(0.5),
                "拍照流程说明", font_size=22, bold=True, color=ACCENT_BLUE)
    ...
    add_paragraph(tf, "   自动重新调起（约0.3秒），无需重新选择类型即可拍摄下一张。", font_size=15, color=LIGHT_GRAY, space_before=Pt(2))
    add_paragraph(tf, "   按手机返回键结束拍摄。", font_size=15, color=LIGHT_GRAY, space_before=Pt(2))
    
    add_paragraph(tf, "3. 自动编号", font_size=16, bold=True, color=WHITE, space_before=Pt(12))
    add_paragraph(tf, "   同一类型照片自动编号：01、02、03...", font_size=15, color=LIGHT_GRAY, space_before=Pt(3))
    
    add_paragraph(tf, "4. 水印与命名", font_size=16, bold=True, color=WHITE, space_before=Pt(12))
    add_paragraph(tf, "   拍摄时自动添加水印，并按设置的规则自动命名文件", font_size=15, color=LIGHT_GRAY, space_before=Pt(3))
    
    add_paragraph(tf, "5. 结束拍摄", font_size=16, bold=True, color=WHITE, space_before=Pt(12))
    add_paragraph(tf, "   按手机返回键结束当前类型拍摄，返回客户列表", font_size=15, color=LIGHT_GRAY, space_before=Pt(3))
    ...
    add_screen_element(slide, screen_left + Inches(0.2), screen_top + Inches(0.5), screen_w - Inches(0.4), Inches(0.4),
                       " <- 返回   张三 - 拍照", bg_color=ACCENT_BLUE, font_size=9)
    ...
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(4.9), screen_w - Inches(0.6), Inches(0.3),
                       "水印：2026-06-28 14:30 | 沈阳市...", font_size=6, bg_color=RGBColor(0x33,0x33,0x40))
    ...
    add_textbox(slide, Inches(0.5), Inches(1.4), Inches(6.5), Inches(0.5),
                "照片管理功能", font_size=22, bold=True, color=ACCENT_BLUE)
    ...
    add_paragraph(tf, "删除全部照片", font_size=18, bold=True, color=WHITE, space_before=Pt(14))
    add_paragraph(tf, "页面提供「删除全部」按钮，点击后同样需要二次确认，可快速清空该客户所有照片后重新拍摄。", font_size=15, color=LIGHT_GRAY, space_before=Pt(5))
        ...
        for c in range(3):
            ...
            if idx < 6:
                add_screen_element(slide, screen_left + Inches(0.2) + thumb_w * c + Inches(0.03),
                                   thumb_y + Inches(0.95) * r + Inches(0.03),
                                   thumb_w - Inches(0.06), Inches(0.85),
                                   f"照片{idx+1:02d}", bg_color=RGBColor(0x40,0x40,0x50), font_size=8)
    
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(4.6), screen_w - Inches(0.6), Inches(0.4),
                       "[删除全部]（需二次确认）", bg_color=RGBColor(0x8B,0x3A,0x3A), font_size=9)
    ...
    add_textbox(slide, Inches(0.5), Inches(1.4), Inches(6.5), Inches(0.5),
                "设置项说明", font_size=22, bold=True, color=ACCENT_BLUE)
    ...
    add_screen_element(slide, screen_left + Inches(0.2), screen_top + Inches(0.5), screen_w - Inches(0.4), Inches(0.4),
                       " <- 返回   设置", bg_color=ACCENT_BLUE, font_size=10)
    
    set_y = screen_top + Inches(1.1)
    add_screen_element(slide, screen_left + Inches(0.3), set_y, Inches(1.5), Inches(0.32),
                       "命名规则：", font_size=8, bg_color=SCREEN_BG)
    for i in range(4):
        add_screen_element(slide, screen_left + Inches(1.9) + Inches(0.65)*i, set_y, Inches(0.6), Inches(0.32),
                           f"段{i+1}v", bg_color=DARK_GRAY, font_size=6)
    
    add_screen_element(slide, screen_left + Inches(0.3), set_y + Inches(0.55), Inches(1.5), Inches(0.32),
                       "水印内容：", font_size=8, bg_color=SCREEN_BG)
    for i in range(3):
        add_screen_element(slide, screen_left + Inches(1.9) + Inches(0.85)*i, set_y + Inches(0.55), Inches(0.8), Inches(0.32),
                           f"水{i+1}v", bg_color=DARK_GRAY, font_size=6)
    
    add_screen_element(slide, screen_left + Inches(0.3), set_y + Inches(1.1), Inches(1.5), Inches(0.32),
                       "水印字号：", font_size=8, bg_color=SCREEN_BG)
    add_screen_element(slide, screen_left + Inches(1.9), set_y + Inches(1.1), Inches(2.2), Inches(0.32),
                       "大  |  中  |  小", font_size=8)
    
    add_screen_element(slide, screen_left + Inches(0.3), set_y + Inches(1.65), Inches(1.5), Inches(0.32),
                       "水印位置：", font_size=8, bg_color=SCREEN_BG)
    add_screen_element(slide, screen_left + Inches(1.9), set_y + Inches(1.65), Inches(2.2), Inches(0.32),
                       "左上 右上 左下 右下", font_size=7)
    
    add_screen_element(slide, screen_left + Inches(0.8), screen_top + Inches(4.5), screen_w - Inches(1.6), Inches(0.55),
                       "[ 保 存 设 置 ]", bg_color=ACCENT_BLUE, font_size=13)
    ...
    add_textbox(slide, Inches(0.5), Inches(1.4), Inches(6.5), Inches(0.5),
                "水印配置详解", font_size=22, bold=True, color=ACCENT_BLUE)
    
    txBox = slide.shapes.add_textbox(Inches(0.5), Inches(1.95), Inches(6.5), Inches(5.0))
    tf = txBox.text_frame
    tf.word_wrap = True
    
    add_paragraph_ex = lambda txt, sz=15, b=False, c=LIGHT_GRAY, sb=Pt(6): add_paragraph(tf, txt, font_size=sz, bold=b, color=c, space_before=sb)
    ...
    p.font.color.rgb = WHITE
    p.font.name = '微软雅黑'
    add_paragraph_ex("每段水印内容可从以下选项中选择：", sb=Pt(6))
    for opt in ["拍摄时间（精确到分钟）", "客户名称", "地址全（概+精确拼接）", "地址概", "地址精确", "GPS定位坐标", "空值（不显示该段）"]:
        add_paragraph_ex("  - " + opt, sb=Pt(3))
    
    add_paragraph_ex("字号选择", sz=18, b=True, c=WHITE, sb=Pt(12))
    add_paragraph_ex("  - 大字号：约48pt，适合远距离查看", sb=Pt(3))
    add_paragraph_ex("  - 中字号：约36pt，默认推荐大小", sb=Pt(3))
    add_paragraph_ex("  - 小字号：约24pt，适合信息较多时使用", sb=Pt(3))
    
    add_paragraph_ex("位置选择", sz=18, b=True, c=WHITE, sb=Pt(12))
    add_paragraph_ex("  - 右上角：不遮挡主体时的首选位置", sb=Pt(3))
    add_paragraph_ex("  - 右下角：常用位置，适合横向拍摄", sb=Pt(3))
    add_paragraph_ex("  - 左上角：天空/浅色背景时使用", sb=Pt(3))
    add_paragraph_ex("  - 左下角：地面/深色背景时使用", sb=Pt(3))
    ...
    photo_area = add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(0.5), screen_w - Inches(0.6), Inches(4.8),
                                    "[ 示例照片区域 ]", bg_color=RGBColor(0x35,0x35,0x42), font_size=9)
    
    add_screen_element(slide, screen_left + Inches(0.5), screen_top + Inches(0.7), Inches(1.5), Inches(0.4),
                       "【左上水印】", bg_color=RGBColor(0x55,0x55,0x55), font_size=6)
    add_screen_element(slide, screen_left + screen_w - Inches(2.0), screen_top + Inches(0.7), Inches(1.5), Inches(0.4),
                       "【右上水印】", bg_color=RGBColor(0x55,0x55,0x55), font_size=6)
    add_screen_element(slide, screen_left + Inches(0.5), screen_top + Inches(4.6), Inches(1.5), Inches(0.4),
                       "【左下水印】", bg_color=RGBColor(0x55,0x55,0x55), font_size=6)
    add_screen_element(slide, screen_left + screen_w - Inches(2.0), screen_top + Inches(4.6), Inches(1.5), Inches(0.55),
                       "【右下水印】\n2026-06-28\n张三 和平区...", bg_color=RGBColor(0x55,0x55,0x55), font_size=6)
    ...
    add_textbox(slide, Inches(0.5), Inches(1.4), Inches(6.5), Inches(0.5),
                "命名规则说明", font_size=22, bold=True, color=ACCENT_BLUE)
    ...
    p.font.color.rgb = WHITE
    p.font.name = '微软雅黑'
    add_paragraph(tf, "文件名由4个可配置的字段段组合而成，各段之间用连字符「-」连接。每段可选择以下字段之一：", font_size=15, color=LIGHT_GRAY, space_before=Pt(6))
    ...
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(0.6), screen_w - Inches(0.6), Inches(0.4),
                       "文件名结构：", bg_color=SCREEN_BG, font_size=10)
    ...
    add_screen_element(slide, screen_left + Inches(0.3), screen_top + Inches(3.7), screen_w - Inches(0.6), Inches(1.0),
                       "最终文件名：\n20260628-张三-和平区XX街123号1430\n-远景-01.jpg", bg_color=RGBColor(0x25,0x45,0x25), font_size=7)
    
    add_page_number(slide, 11, total_slides)
    
    # ==================== 第12页：第十章 常见问题（分两页避免字体重叠）====================
    slide = prs.slides.add_slide(blank_layout)
    set_slide_bg(slide)
    add_title_bar(slide, "第十章  常见问题（上）")
    
    faqs_top = [
        ("Q1: 点击拍照后相机没有启动？", 
         "A: 请先确认已授予相机权限（手机设置→应用管理→本应用→权限管理）。如仍无法启动，请确认手机系统相机应用是否正常工作。部分定制系统需手动开启「相机」权限。也可通过USB连接电脑，使用adb logcat查看详细错误日志。"),
        ("Q2: GPS定位不准或无法获取？", 
         "A: 请确保手机已开启GPS定位功能，并在开阔地带使用。室内可能影响GPS信号接收。水印中定位信息需等待GPS定位成功后才会显示，首次定位可能需要30秒左右。"),
        ("Q3: 照片保存在哪里？", 
         "A: 照片保存在应用私有目录下，系统相册也可查看。导出时可通过手机文件管理器或USB连接电脑拷贝。"),
    ]
    
    y_pos = Inches(1.5)
    for q, a in faqs_top:
        qbox = add_textbox(slide, Inches(0.5), y_pos, Inches(12.3), Inches(0.4),
                           q, font_size=17, bold=True, color=ACCENT_BLUE)
        atxBox = slide.shapes.add_textbox(Inches(0.8), y_pos + Inches(0.4), Inches(11.8), Inches(1.3))
    ...
    slide = prs.slides.add_slide(blank_layout)
    set_slide_bg(slide)
    add_title_bar(slide, "第十章  常见问题（下）")
    ...
    # 封底信息放在下半部分
    add_textbox(slide, Inches(1), Inches(4.5), Inches(11), Inches(0.7),
                "感谢使用", font_size=36, bold=True, color=WHITE, align=PP_ALIGN.CENTER)
    
    contact_box = slide.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(3.5), Inches(5.4), Inches(6), Inches(1.4))
    ...
    add_paragraph(ctf, "作者：王硕", font_size=16, color=WHITE, space_before=Pt(8))
