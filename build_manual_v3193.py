...
DST = r'C:\Users\Administrator\Desktop\资产盘点拍照工具-使用说明书-v3.22.13.pptx'
...
add_text(slide, Inches(0.8), Inches(3.8), Inches(5.2), Inches(0.5),
         "v3.22.13", font_size=18, color=C_WHITE)
# 底部署名
...
add_text(slide, wx + Inches(0.3), wy + Inches(2.2), ww - Inches(0.6), Inches(0.35),
         "v3.22.13", font_size=10, color=C_TEXT_DIM, align=PP_ALIGN.CENTER)
# 功能列表
features = [
    "四类拍照引导（远景/近景/内部/瑕疵）",
    "水印自选模式（段+位置+字号）",
