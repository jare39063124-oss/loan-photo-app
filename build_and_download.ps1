...
$finalApkName = "loan-photo-tool-v3.22.6.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v3226.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v3226-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.22.6 APK READY!" -ForegroundColor Green
