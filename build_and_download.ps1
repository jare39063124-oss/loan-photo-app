...
$finalApkName = "loan-photo-tool-v3.22.15.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v3228.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v3228-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.22.15 APK READY!" -ForegroundColor Green
