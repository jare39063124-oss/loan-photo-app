...
$finalApkName = "loan-photo-tool-v3.20.0.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v3200.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v3200-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.20.0 APK READY!" -ForegroundColor Green
