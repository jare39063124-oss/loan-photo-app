...
$finalApkName = "loan-photo-tool-v3.7.2.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v372.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v372-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.7.2 APK READY!" -ForegroundColor Green
