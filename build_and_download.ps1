...
$finalApkName = "loan-photo-tool-v3.19.3.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v3193.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v3193-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.19.3 APK READY!" -ForegroundColor Green
