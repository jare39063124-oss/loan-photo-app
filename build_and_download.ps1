...
$finalApkName = "loan-photo-tool-v3.18.1.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v3181.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v3181-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.18.1 APK READY!" -ForegroundColor Green
