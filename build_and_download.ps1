...
$finalApkName = "loan-photo-tool-v3.22.7.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v3227.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v3227-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.22.7 APK READY!" -ForegroundColor Green
