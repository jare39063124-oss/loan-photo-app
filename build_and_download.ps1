...
$finalApkName = "loan-photo-tool-v3.22.0.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v3220.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v3220-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.22.0 APK READY!" -ForegroundColor Green
