...
$finalApkName = "loan-photo-tool-v3.22.5.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v3225.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v3225-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.22.5 APK READY!" -ForegroundColor Green
