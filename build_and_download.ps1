...
$finalApkName = "loan-photo-tool-v3.22.4.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v3224.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v3224-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.22.4 APK READY!" -ForegroundColor Green
