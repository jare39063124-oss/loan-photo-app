...
$finalApkName = "loan-photo-tool-v3.19.0.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v3190.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v3190-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.19.0 APK READY!" -ForegroundColor Green
