...
$finalApkName = "loan-photo-tool-v3.22.2.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v3222.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v3222-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.22.2 APK READY!" -ForegroundColor Green
