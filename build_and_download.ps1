...
$finalApkName = "loan-photo-tool-v3.22.3.apk"
...
$tempZip = Join-Path $env:TEMP "loan-apk-v3223.zip"
$extractDir = Join-Path $env:TEMP "loan-apk-v3223-extract"
...
if ($apks.Count -gt 0) {
    ...
    Write-Host "  v3.22.3 APK READY!" -ForegroundColor Green
