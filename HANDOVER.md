...
> **最新 APK**: `C:\Users\Administrator\Desktop\loan-photo-tool-v3.22.21.apk` (待构建)
> **最新 PPT**: `C:\Users\Administrator\Desktop\资产盘点拍照工具-使用说明书-v3.22.21.pptx` (待生成, 16 页)
>
> **APK 下载链接(nightly.link)**:
> https://nightly.link/jare39063124-oss/loan-photo-app/actions/runs/28749105722/loan-photo-apk.zip
...
| **v3.22.21** | **修复：1) 删除缩略图二次确认提示原图保留（相册原图需手动删除）+ 2) 缩略图 2 列竖向布局 + 横版照片逆时针旋转 90° + 3) ColoredCheckBox 形状还原到 20dp×20dp + 4) 多选拍摄计数逻辑（多选 N 条目拍一张照片全部计数 +1，相册仅 1 张；AI 日报表/助手 prompt 注入多选语义）+ 5) AI 拍摄助手键盘遮挡修复（keyboard_spacer + on_leave 不解绑）+ 6) 全局 bug 审计（PIL Image 关闭 + tmp_rotated 清理 + CardWidget 硬编码改 dp）** | 🔄 待构建 |
...
| 文件 | 说明 |
|------|------|
| `C:\Users\Administrator\Desktop\loan-photo-tool-v3.22.21.apk` | **最新 APK**(v3.22.21, 待构建) |
| `C:\Users\Administrator\Desktop\资产盘点拍照工具-使用说明书-v3.22.21.pptx` | **最新 PPT 说明书**(16 页, 待生成) |
