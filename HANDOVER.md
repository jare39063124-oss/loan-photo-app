...
> **Git Commit**: `721bebf`
> **GitHub Actions Run**: `28753552339` (Build #89, 1066s)
> **最新 APK**: `C:\Users\Administrator\Desktop\loan-photo-tool-v3.22.21.apk` (已构建, 29.03 MB)
> **最新 PPT**: `C:\Users\Administrator\Desktop\资产盘点拍照工具-使用说明书-v3.22.21.pptx` (已生成, 16 页, 67.15 KB)
>
> **APK 下载链接(nightly.link)**:
> https://nightly.link/jare39063124-oss/loan-photo-app/actions/runs/28753552339/loan-photo-apk.zip
