...
> **最新 APK**: `C:\Users\Administrator\Desktop\loan-photo-tool-v3.22.18.apk` (待构建)
> **最新 PPT**: `C:\Users\Administrator\Desktop\资产盘点拍照工具-使用说明书-v3.22.18.pptx` (待生成, 16 页)
>
> **APK 下载链接(nightly.link)**:
> https://nightly.link/jare39063124-oss/loan-photo-app/actions/runs/28712601573/loan-photo-apk.zip
...
| **v3.22.18** | **P0:PhotoViewerPopup 背景渲染修复 — 从继承 ThemedPopup 改为直接继承 Popup，背景绘制在 content.canvas.before（匹配 _show_report_confirm 有效模式）+ 权限补全 Android 11+ READ_EXTERNAL_STORAGE 和 Android 13+ READ_MEDIA_IMAGES** | 🔄 待构建 |
