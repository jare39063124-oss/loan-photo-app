...
> **Git Commit**: `待构建`
> **GitHub Actions Run**: `待构建`
> **最新 APK**: `C:\Users\Administrator\Desktop\loan-photo-tool-v3.22.17.apk` (待构建)
> **最新 PPT**: `C:\Users\Administrator\Desktop\资产盘点拍照工具-使用说明书-v3.22.17.pptx` (待生成)
>
> **APK 下载链接(nightly.link)**:
> https://nightly.link/jare39063124-oss/loan-photo-app/actions/runs/28711296361/loan-photo-apk.zip
...
| **v3.22.17** | **P0:PhotoViewerPopup auto_dismiss 终极修复 — 增加 self.auto_dismiss=False 防止被同一触摸事件立即关闭（v3.22.16 尺寸已正确但 ModalView.on_touch_down 检测到触摸点在 popup 外部触发 auto_dismiss）+ 全项目 Bug 审计修复 9 处（2 处 on_release→on_press + 7 处裸 except→具体异常类型）** | 待构建 |
