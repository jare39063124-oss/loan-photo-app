...
> **交接日期**: 2026-07-03
> **当前版本**: v3.22.11 (已提交 + 已构建)
> **项目路径**: `d:\hermes\loan_photo_app\`
> **Git 仓库**: `jare39063124-oss/loan-photo-app` (GitHub Actions 自动构建)
> **最新 APK**: `C:\Users\Administrator\Desktop\loan-photo-tool-v3.22.11.apk`
> **最新 PPT**: `C:\Users\Administrator\Desktop\资产盘点拍照工具-使用说明书-v3.22.11.pptx` (16 页)
...
| **v3.22.11** | **P0:回退 v3.22.10 引入的回归 — 移除 touch.grab/ungrab（与 ButtonBehavior 内部 grab 冲突导致查看已拍触发7次）+ 移除 DebugOverlay 类（220×120dp 覆盖 AI 助手按钮导致无反应）+ 新增 _on_view_photos 500ms 防抖双保险 + 长按 1.2s→0.8s；保留 always_release=True 和 softinput_mode=pan** | ⏳ 待构建 |
