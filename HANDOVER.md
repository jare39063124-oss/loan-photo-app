...
> **Git Commit**: `39671d2`
> **GitHub Actions Run**: `28747164492` (Build #85, 构建中)
> **最新 APK**: `C:\Users\Administrator\Desktop\loan-photo-tool-v3.22.19.apk` (待构建)
> **最新 PPT**: `C:\Users\Administrator\Desktop\资产盘点拍照工具-使用说明书-v3.22.19.pptx` (已生成, 68765 字节, 16 页)
>
> **APK 下载链接(nightly.link)**:
> https://nightly.link/jare39063124-oss/loan-photo-app/actions/runs/28747164492/loan-photo-apk.zip
