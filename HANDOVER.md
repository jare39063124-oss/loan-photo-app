...
> **最新 APK**: `C:\Users\Administrator\Desktop\loan-photo-tool-v3.22.16.apk` (需手动下载，见下方 nightly.link)
> **最新 PPT**: `C:\Users\Administrator\Desktop\资产盘点拍照工具-使用说明书-v3.22.16.pptx` (已生成, 68764 字节, 16 页)
>
> **APK 下载链接(nightly.link)**:
> https://nightly.link/jare39063124-oss/loan-photo-app/actions/runs/28705924075/loan-photo-apk.zip
...
| **v3.22.16** | **P0:PhotoViewerPopup 可见性终极修复 — 显式设置 self.size=self.center 替代 size_hint（v3.22.15 诊断日志显示 size=[100,100] pos=[0,0] 证明 size_hint 在 Android 上未生效）+ 移除 Clock.schedule_once 延迟包装（非根因，直接创建+open）** | 待构建 |
