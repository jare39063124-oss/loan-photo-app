...
| **v3.22.3** | **P0备注覆盖(按行号独立存储)+倒角dp(12)+AI报表默认文件名(JString)+高亮会话期间保持+日志回退内存缓冲** | 🔄 构建中 |
...
| 文件 | 说明 |
|------|------|
| `C:\Users\Administrator\Desktop\loan-photo-tool-v3.22.0.apk` | **最新 APK**(v3.22.0, 28.61 MB) |
| `C:\Users\Administrator\Desktop\资产盘点拍照工具-使用说明书-v3.22.0.pptx` | **最新 PPT 说明书**(15 页) |
